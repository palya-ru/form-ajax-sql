...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/js.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _script_validate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./script/validate */ "./src/js/script/validate.js");


window.addEventListener('DOMContentLoaded', function () {
  Object(_script_form__WEBPACK_IMPORTED_MODULE_0__["default"])('.form');
  Object(_script_validate__WEBPACK_IMPORTED_MODULE_1__["default"])();
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var form = function form(elem) {
  var block = document.querySelector(elem);

  function _close(elem) {
    var block = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'none';
...
var validate = function validate() {
  ...
  var inputs = document.querySelectorAll('.forms-group__input');
  var message = {
    loading: 'Загрузка...',
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              throw new Error("\u0427\u0442\u043E \u0442\u043E ".concat(url, ", \u0438 \u043D\u0435 \u0442\u043E ").concat(res.status));
  ...
  document.addEventListener('submit', function (ev) {
    ...
    if (target && target.classList.contains('forms')) {
      ...
      if (validateForm(inputs)) {
        postData('index.php', formData).then(function () {}).then(function (res) {
          //console.log(res);
          send.textContent = message.success;
        })["catch"](function () {
          return send.textContent = message.error;
        })["finally"](function () {
          clearInput(inputs);
          setTimeout(function () {
